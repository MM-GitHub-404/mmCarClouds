...
<script type="text/javascript">
    function fileChange() {//注意：此处不能使用jQuery中的change事件，因此仅触发一次，因此使用标签的：onchange属性
        /*alert("change");*/
        $.ajaxFileUpload({
            url: '/user/uploadPicture',//用于文件上传的服务器端请求地址图片上传
...
<div id="addAll">
    ...
    <div id="table">
        <form action="${pageContext.request.contextPath}/user/newUser" enctype="multipart/form-data"
              method="post" id="myform">
            <table>
                <tr>
                    <td class="three">用户头像</td>
                    <td><br>
                        <div id="imgDiv" style="display:block; width: 55px; height: 35px;"></div>
                        <br><br><br><br>
                ...
                <tr>
                    ...
                    <td><input type="number" name="uPhone" class="two"></td>
                </tr>
                <!--错误提示-->
                <tr class="three">
                    <td class="four"></td>
                ...
                <tr>
                    ...
                    <td><input type="number" name="uIntegral" class="two"></td>
                </tr>
                <!--错误提示-->
                <tr class="three">
                    <td class="four"></td>
                    ...
                    <td>
                        ...
                        <script type="text/javascript">
                            function myclose(ispage) {
                                window.location = "${pageContext.request.contextPath}/user/firstPage?page=" + ispage;
                            }
                        </script>
                    </td>
                </tr>
